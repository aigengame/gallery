...
- Keep source, asset prompts, pipeline, evidence summaries, and local commits.
  Binary assets use Git LFS. Do not push or publish.
- The agent owns production decisions and acceptance; no HITL gate is required.
